...
1	1	godmode	7952746f9eef903c5410e6ed1c123f1fc242b74f5dfcd675529ddc1c656640318ba101edbdcff4795dae41f982cef22b71c5	MGBXYzE6Ro	1736d4d3	all,sudo	1688828494	1688828494
\.
...
COPY public.action_run (id, title, repo_id, owner_id, workflow_id, index, trigger_user_id, ref, commit_sha, is_fork_pull_request, event, event_payload, status, started, stopped, created, updated) FROM stdin;
\.
...
COPY public.action_runner (id, uuid, name, owner_id, repo_id, description, base, repo_range, token_hash, token_salt, last_online, last_active, agent_labels, custom_labels, created, updated, deleted) FROM stdin;
\.
...
1	1	gitea@example.nl	gitea@example.nl	t	t
\.
...
1f81ed64c0040669a4e19c3b81b28087	gitea@example.nl
\.
...
COPY public.label (id, repo_id, org_id, name, exclusive, description, color, num_issues, num_closed_issues, created_unix, updated_unix) FROM stdin;
\.
...
COPY public.mirror (id, repo_id, "interval", enable_prune, updated_unix, next_update_unix, lfs_enabled, lfs_endpoint) FROM stdin;
\.
...
COPY public.package (id, owner_id, repo_id, type, name, lower_name, semver_compatible) FROM stdin;
\.
...
COPY public.push_mirror (id, repo_id, remote_name, sync_on_commit, "interval", created_unix, last_update, last_error) FROM stdin;
\.
...
1	picture.disable_gravatar	false	1	1688827959	1688827959
2	picture.enable_federated_avatar	true	1	1688827959	1688827959
\.
...
1	gitea	gitea		gitea@example.nl	f	enabled	42a318fa2305a8e124a3adeaf62e1eb2e52232d898260a46589c3c9451d5e4a70ecc1460c5fa9a013d1d2ee75ef9df4a89f6	pbkdf2$50000$50	f	0	0		0			9b72bdf83568aa171ca9c1a24d9a1369	cbafb9ec24152aa332c69857fd34371a	en-US		1688827960	1688827964	0	f	-1	t	t	f	f	f	t	f		gitea@example.nl	f	0	0	0	0	0	0	0	f		auto	f
\.
...
COPY public.webhook (id, repo_id, org_id, is_system_webhook, url, http_method, content_type, secret, events, is_active, type, meta, last_status, header_authorization_encrypted, created_unix, updated_unix) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.system_setting_id_seq', 2, true);
